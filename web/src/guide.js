...
export const STEPS = [
  ...
  },
  {
    icon: '📚',
    title: 'Add a novel',
    instruction: 'Add a book in one of three ways: paste a Google Docs link, paste the text / load a .txt file, or add photos of the pages.',
    flow: ['Your doc, text or photos', 'Add a novel', 'It appears in your library'],
    how: [
      ...
      '“Photos”: for a book you only have as pictures. See the next step.',
    ],
    go: 'library',
  ...
  {
    icon: '📷',
    title: 'Read a novel from photos',
    instruction: 'Have photos of printed pages, screenshots, or scans? Claude reads the Korean out of each picture, you check it, and then it translates like any other novel.',
    flow: ['Your photos', 'Claude reads them', 'You check the text', 'Build chapters', 'Translate'],
    how: [
      'Add the novel with “Photos”, then drop the images onto the “Pages” tab.',
      'Photos you add together count as one chapter. Add the next chapter’s photos as a separate batch.',
      'Press “Read” and the Korean appears beside each photo. Anything Claude wasn’t sure of is marked “Needs a check”.',
      'Fix anything wrong by typing in the box. “Check against the photo” has Claude compare the two and point out differences.',
      '“Work out the joins” decides where one page runs straight into the next. This matters: a sentence that carries across a page break must not become two paragraphs.',
      'Watch for a red “page missing?” marker between two pages — that usually means a page never got photographed.',
      'When the pages look right, press “Build chapters”. From then on it behaves exactly like any other novel.',
      'iPhone photos need Settings → Camera → Formats → Most Compatible, or the app can’t read them.',
    ],
  },
  {
    icon: '🌐',
  ...
  {
    icon: '✍️',
    title: 'Fix a paragraph that reads awkwardly',
    instruction: 'Don’t like how one paragraph came out? Rewrite just that paragraph, without touching the rest of the chapter.',
    flow: ['Hover a paragraph', 'Rephrase or re-translate', 'Compare the versions', 'Keep the one you like'],
    how: [
      'While reading, hover a paragraph and click the ✎ in the margin — or press “r” for the paragraph you’re looking at.',
      '“Rephrase” rewords the English. Tell it how (“less stiff”, “shorter”), or just press it.',
      '“Re-translate” goes back to the Korean and translates that paragraph again.',
      'Every attempt is kept, so you can compare them and pick. Nothing changes in the chapter until you press “Use this”.',
      'The first entry is always the original, so you can always go back.',
    ],
  },
  {
    icon: '✅',
